...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { address: @admin_user.address, email: @admin_user.email, first_name: @admin_user.first_name, last_name: @admin_user.last_name, mobile_no: @admin_user.mobile_no }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { address: @admin_user.address, email: @admin_user.email, first_name: @admin_user.first_name, last_name: @admin_user.last_name, mobile_no: @admin_user.mobile_no }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
